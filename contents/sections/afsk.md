Eine Sonderform der digitalen Modulation stellt das Audio Frequency Shift Keying (AFSK) dar. Im Gegensatz zu ASK steht hier das "A" nicht für Amplitude, sondern für Audio, also für hörbare Frequenzen (Niederfrequenz): Es wird eine Frequenzumtastung (FSK) im Bereich deutlich unter $\qty{20}{\kilo\hertz}$ durchgeführt. Oftmals wird der Bereich von ca. $\qty{300}{\hertz}$ bis $\qty{2700}{\hertz}$ genutzt.
...
AFSK erreicht meist nur geringe Datenübertragungsraten. Es können also nur wenige Daten pro Zeit übertragen werden. Dafür funktioniert es mit fast jedem Funkgerät. Mikrofon- und Lautsprecheranschluss genügen. Bei APRS auf $\qty{144,800}{\mega\hertz}$ verwendet man beispielsweise eine Datenübertragungsrate von $\qty{1200}{\bit\per\second}$.
